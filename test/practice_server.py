...
sys.path.append("..")
import test
from test.strategy_two import send_test_again
from test.strategy_one import process_initialization, every_interaction
...
def init_test():
    ...
    if knowledge_ids_num <= 3:
        # "策略一"
        init_json = test.strategy_one.process_initialization(receive_json)
        return init_json
    else:
        # "策略二"
        init_json = test.strategy_two.process_initialization(receive_json)
        return init_json
